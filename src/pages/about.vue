    ...
    <v-container class="h-100 d-flex align-center justify-center ">
      ...
      <div class="w-100 w-md-50 text-center">
        ...
        <div class="d-flex ga-4 justify-space-around">
          <v-card color="" class="pa-3 rounded-lg border-sm d-flex ">
            <v-btn v-for="social in socials" :key="social.icon" icon :href="social.href" target="_blank" class=" mx-2 border-dashed border border-primary border-opacity-100 bg-black"
              variant="outlined">
